                ...
                <div className="bg-white/85 max-w-md px-6 py-8 rounded-2xl shadow-lg">
                    {loading ? (
                        ...
                        <>
                            ...
                            <p className="text-lg mb-6 text-black">Posso confirmar sua presença no Chá da Melinda?</p>
                            <div className="flex gap-4 justify-center">
                                <button
                                    onClick={() => handleResposta("sim")}
                                    className="bg-yellow-400 hover:bg-yellow-500 transition px-6 py-2 rounded-full font-semibold"
                                >
                                    Sim 🐝
                                </button>
                                <button
                                    onClick={() => handleResposta("nao")}
                                    className="bg-red-400 hover:bg-red-500 text-white transition px-6 py-2 rounded-full font-semibold"
                                >
                                    Não 😢
                                </button>
                            </div>
